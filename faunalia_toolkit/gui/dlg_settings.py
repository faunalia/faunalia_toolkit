...
# project
from faunalia_toolkit.__about__ import (
    DIR_PLUGIN_ROOT,
    __icon_path__,
    __title__,
    __uri_homepage__,
...
from faunalia_toolkit.toolbelt import PlgLogger, PlgOptionsManager
from faunalia_toolkit.toolbelt.preferences import PlgSettingsStructure
